...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent ref={ref} className={cn("z-50 min-w-[8rem] overflow-hidden rounded-md border bg-white p-1 text-[hsl(var(--foreground))] shadow-lg", className)} {...props} />
));
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn("z-50 min-w-[8rem] overflow-hidden rounded-md border bg-white p-1 text-[hsl(var(--foreground))] shadow-md", className)}
      {...props}
    />
  </DropdownMenuPrimitive.Portal>
));
